...
const INDICATORS_DATA = [
  ...
  { 
    ...
    desc: 'Inodoros • JMP Servicio Básico de Agua.', 
  ...
  { 
    ...
    guidance: 'En pisos planos se deben usar carritos cerrados y separados. En caso de pisos rústicos o sin accesibilidad, las bolsas deben transportarse sin arrastrar y sin pegar al cuerpo del personal.', 
    jmp: false, 
    score: null, 
    notes: '', 
  ...
  { 
    ...
    eval0: 'Se realiza el lavado de los carritos cada mes o nunca.', 
    severity: 3, likelihood: 3, problemDesc: '', associatedRisks: '', action: '', targetDate: '', resources: '', responsible: '', cost: null, trackingStatus: 'No Iniciado', revisionNotes: '' 
  },
  { 
    id: 'RES_8', 
    ...
    score: null, 
    notes: '', 
    eval2: 'Sí, se dispone de una zona dedicada exclusivamente de almacenamiento de residuos, con capacidad suficiente para almacenarlos.', 
  ...
  { 
    ...
    guidance: 'Los registros de firmas de limpieza deben estar visibles en cada pabellón para permitir el control y la auditoría diaria de supervisión técnica conforme a las mejores prácticas de los CDC.', 
    jmp: false, 
    score: null, 
    notes: '', 
